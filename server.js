...
/* v4 : 차대차 충돌은 shared.js resolveCarCar(그룹 CCD)로 통합 틱에서 해석한다. */
...
/* v4 : 구 state 디코딩(decodeState)/스냅샷 v2·v3 인코딩(encodeSnapshot)/applyState 는
 *  폐지됐다. 위치는 서버 시뮬이 권위이고, 와이어는 MSG_INPUT/MSG_SNAP4 만 쓴다. */
