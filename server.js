...
const RECORD_FIELD = { a1: "bestA1", a2: "bestA2", a3: "bestA3", racing: "bestB1", hard: "bestB2", serp: "bestB3", c1: "bestC1", c2: "bestC2", c3: "bestC3", retro1: "bestTime", retro2: "bestTimeHard", boss: "bestBoss" };
...
const COURSE_LABEL = { a1: "A-1", a2: "A-2", a3: "A-3", racing: "B-1", hard: "B-2", serp: "B-3", c1: "C-1", c2: "C-2", c3: "C-3", retro1: "레트로1", retro2: "레트로2", boss: "보스전" };
function courseModeOf(token) {
  const t = String(token || "").toLowerCase().replace(/-/g, "");
  const map = { a1: "a1", a2: "a2", a3: "a3", b1: "racing", b2: "hard", b3: "serp", c1: "c1", c2: "c2", c3: "c3", "레트로1": "retro1", "레트로2": "retro2", "보스전": "boss", "보스": "boss" };
  return map[t] || null;
}
...
const BOSS_PILLARS = [ // 기둥 : 돌진을 유도해 그로기를 만드는 엄폐물 (클라 렌더/충돌과 동일해야 함)
