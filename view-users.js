...
//  정렬:  node view-users.js best       초보자 코스 기록 빠른순
//         node view-users.js hard       어려움 코스 기록 빠른순
...
const cols = [
  ...
  { h: "초보자", get: (u) => fmtRace(u.bestTime), pad: padL },
  { h: "어려움", get: (u) => fmtRace(u.bestTimeHard), pad: padL },
...
console.log(`\n총 ${rows.length}명  ·  정렬: ${key}  (best/hard/time/wins/name 으로 바꿀 수 있어요)\n`);
